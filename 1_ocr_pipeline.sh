...
# # ####### Specs (1 image): 2x8GB; 1xh100 and 60min
...
# python3 -m src.workflows.evaluate_extraction --results data/corpus_construction/vlm_extraction/results/gestion/none.parquet --gold data/corpus_construction/evaluate_extraction/gestion.csv --output-csv data/corpus_construction/evaluate_extraction/results/gestion/none.csv
# python3 -m src.workflows.evaluate_extraction --results data/corpus_construction/vlm_extraction/results/gestion/cropped.parquet --gold data/corpus_construction/evaluate_extraction/gestion.csv --output-csv data/corpus_construction/evaluate_extraction/results/gestion/cropped.csv